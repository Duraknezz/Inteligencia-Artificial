...
MAX_DOCS = 5000  # límite de comentarios a cargar

df = pd.read_csv(
    'Proyecto3/dataset_sintetico_5000_ampliado.csv',
    encoding='latin-1',
    on_bad_lines='skip',
    nrows=MAX_DOCS  # <= 500 filas leídas
)

print(f"Filas cargadas: {len(df)} (límite {MAX_DOCS})")
